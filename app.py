...
df['model_year'] = df['model_year'].apply(np.float64)
df['primodel_yearce'] = df['model_year'].fillna(0)
df['cylinders'] = df['cylinders'].apply(np.float64)
df['cylinders'] = df['cylinders'].fillna(0)
df['is_4wd'] = df['is_4wd'].apply(np.float64)
df['is_4wd'] = df['is_4wd'].fillna(0)
df['odometer'] = df['odometer'].apply(np.float64)
df['odometer'] = df['odometer'].fillna(0)
df['days_listed'] = df['days_listed'].apply(np.float64)
